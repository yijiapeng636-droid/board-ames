...
const reasonLabels: Record<AgentFallbackReason, string> = {
  ...
  unexpected_final_tool_call: '模型在明确禁止工具的最终轮仍返回了工具调用',
  ...
  model_response_truncated: '模型输出达到长度上限，最终 JSON 被截断',
...
const inferredStage: Partial<Record<AgentFallbackReason, AgentFailureStage>> = {
  ...
  round_budget_exceeded: 'model_response', empty_model_response: 'model_response', unexpected_final_tool_call: 'model_response',
  model_response_truncated: 'model_response',
